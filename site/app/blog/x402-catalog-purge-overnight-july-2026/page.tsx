...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: ['/blog/x402-catalog-purge-overnight-july-2026.png'],
  },
  twitter: {
      ...
      <main id="main-content" className="min-h-screen overflow-hidden bg-[#050509] text-slate-100">
        ...
        <article className="relative px-6 pb-20 pt-28 sm:pt-36">
          ...
          <div className="mx-auto flex max-w-6xl flex-wrap justify-center gap-8 xl:gap-12">
            ...
            <img
              src="/blog/x402-catalog-purge-overnight-july-2026.png"
              alt="A library shelf of glowing catalog cards, half dissolving into particles"
            ...
            <p className="mt-10 text-base leading-8 text-slate-400">
              Related reading:{' '}
              <a href="/blog/x402-bazaar-economy-data-july-2026" className="text-blue-400 hover:text-blue-300">
                the economy data we published six days before the purge
              </a>{' '}
              and{' '}
              <a href="/blog/x402-500-character-description-limit" className="text-blue-400 hover:text-blue-300">
                the 500-character cliff that silently unlists sellers
              </a>
              .
            </p>
            ...
            <BlogArchive current="x402-catalog-purge-overnight-july-2026" />
          </div>
        </article>
