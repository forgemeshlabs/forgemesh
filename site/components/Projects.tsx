const projects = [
  ...
  },
  {
    ...
    version: 'v1.0.0',
    description:
      'AI image generation via x402 micropayments. $0.10 USDC per image on Base mainnet — no API key, pay per call.',
    tags: ['x402', 'image-gen', 'USDC', 'Base'],
    status: 'active',
    github: 'https://github.com/forgemeshlabs/imagegen',
  ...
  },
  {
    ...
    version: 'v0.3.0',
    description:
      'HTTP payment middleware stack. Drop-in x402 facilitator for any API — agents pay per request in USDC on Base mainnet.',
    tags: ['x402', 'USDC', 'Base', 'middleware'],
    status: 'active',
    github: 'https://github.com/forgemeshlabs',
    url: 'https://x402.coinopai.com',
  },
  {
    name: 'forgemesh',
